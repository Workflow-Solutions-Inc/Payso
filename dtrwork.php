...
$dtrpayrollid = '';
	...
	$query = "SELECT format(daysworked,0),2) daysworked,
										format(hoursworked,0),2) hoursworked,
										format(overtimehours,0),2) overtimehours,
										format(nightdifhours,0),2) nightdifhours,
										format(leaves,0),2) leaves,
										format(absent,0),2) absent,
										format(late,0),2) late,
										format(break,0),2) break,
										format(undertime,0),2) undertime,
										format(specialholiday,0),2) specialholiday,
										format(specialholidayot,0),2) specialholidayot,
										format(specialholidaynd,0),2) specialholidaynd,
