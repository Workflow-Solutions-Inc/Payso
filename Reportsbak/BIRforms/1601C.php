...
$query = "call SP_generate2316Form('".$dataareaid."','".$selectedWorker."','".$selectedYear."','".$selectedYear."-01-01','".$selectedYear."-01-31')";
//$query = "CALL payslipRPT('WFSIPY0000005', 'WFSI', 'WFSIWR000002')";
  ...
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(146.5, 55.5);
  $pdf->Write(0, $tinelineno10);

    #column 12
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(151.5, 55.5);
  ...
  $pdf->SetXY(9 , 64);
  $pdf->Write(0,$name);
  //$pdf->Write(0,chunk_split($tname, 1, '   '));

  #RDO Code 1
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(191.5, 55.5);
  $pdf->Write(0, $rdo1);
  #RDO Code 2
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(196.5, 55.5);
  $pdf->Write(0, $rdo2);
  #RDO Code 3
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(201.5, 55.5);
  $pdf->Write(0, $rdo3);
  ...
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(186.5, 81.5);
  $pdf->Write(0, "1");
  #Code 2
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(191.5, 81.5);
  $pdf->Write(0, "1");
  #Code 3
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(196.5, 81.5);
  $pdf->Write(0, "1");

  #Code 4
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(201.5, 81.5);
  $pdf->Write(0, "3");
...
*/
  ...
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(38,87.5);
  //$pdf->Write(0, "09567648259");
  $pdf->Write(0,chunk_split("09567648259", 1, '   '));

  //email address
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(39,93.5);
 // $pdf->Write(0, "lizneyonin@gmail.com");
  $pdf->Write(0,chunk_split($email, 1, '   '));
  ...
  //$pdf->SetXY(-100,113);
  //$pdf->SetX($pdf->lMargin);
  $pdf->Cell( 1, 37.5, chunk_split($tac, 1, '   '), 0, 0, 'R' ); 
  //$pdf->Write(0, $tac);
  ...
  //$pdf->SetXY(-100,113);
  //$pdf->SetX($pdf->lMargin);
  $pdf->Cell( 0.2, 58, chunk_split($tac, 1, '   '), 0, 0, 'R' ); 
  //$pdf->Write(0, $tac);
  ...
  //$pdf->SetXY(-100,113);
  //$pdf->SetX($pdf->lMargin);
  $pdf->Cell( 0.2, 69, chunk_split($tac, 1, '   '), 0, 0, 'R' ); 
  //$pdf->Write(0, $tac);
