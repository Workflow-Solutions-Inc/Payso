...
if($_GET["runrpt"] == "PDF")
    {
                ...
                class MYPDF extends TCPDF {
                    ...
                    public function Header() {
                        ...
                        $this->Cell(5, 1, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');

                        $this->Cell(4, 2, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                        $this->Cell(5, 2, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                        $this->Cell(6, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                        $this->Cell(10, 1, 'Loan Type', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                            ...
                            while ($row = $result->fetch_assoc())
                            {
                                ...
                                $output .= '
                                            ...
                                            <tr>
                                                ...
                                                <td  width="19%"   style="text-align:left">'.$row["lastname"].', '.$row["firstname"].' '.$row["middleinitial"].'.'.'</td>
