...
<body>-->
	...
	<div id="leftpanel" class="leftpanel">
		...
		<ul class="subbuttons">
			...
			<li class="LateSetup" style="display: none;"><button id="myAddBtn"><span class="fa fa-plus"></span> Create Record</button></li>
			<li class="LateSetup" style="display: none;"><button onClick="Delete();"><span class="fa fa-trash-alt"></span> Delete Record</button></li>
			<li class="LateSetup" style="display: none;"><button id="myUpdateBtn"><span class="fa fa-edit"></span> Update Record</button></li>
				...
				<div id="tablearea1" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mainpanel-area">
					<div class="mainpanel-content">
						...
						<div class="mainpanel-title">
							<span class="fa fa-archive"></span> Late Setup
						</div>
						...
						<div id="container1" class="full">
							<table width="100%" style="border: 1px solid #d9d9d9;" id="datatbl" class="table table-striped mainpanel-table">
								...
								<tbody id="result">
									<?php
									$query = "SELECT start,end,value,recid FROM latesetuptable where dataareaid = '$dataareaid' order by start";
									$result = $conn->query($query);
									$rowclass = "rowA";
									$rowcnt = 0;
									$rowcnt2 = 0;
									...
									{ 
										...
										$rowcnt2++;
											...
											$collection = $collection.','.$row['start'];
										?>
										<tr id="<?php echo $row['start'];?>" class="<?php echo $rowclass; ?>" tabindex="<?php echo $rowcnt2; ?>">
											<!--<td style="width:10px;"><input type='checkbox' name="chkbox" value="" id="myCheck"></td>-->
											<td style="width:20px;" class="text-center"><span class="fa fa-angle-right"></span></td>
											<td style="width:33%;"><?php echo $row['start'];?></td>
											<td style="width:33%;"><?php echo $row['end'];?></td>
	...
	<div class="modal-container">
		<div class="modal-content">
			<div class="modal-header">
				<div class="col-lg-6">Late Setup</div>
				<div class="col-lg-6"><span class="fas fa-times modal-close"></span></div>
			</div>
			
			<div id="container" class="modal-content-container">
				<form name="myForm" accept-charset="utf-8" action="lateformprocess.php" method="get">
					<div class="row">

						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Start Time:</label><br>
							<div class="input-group bootstrap-timepicker timepicker input-width-sm">
								<input type="text" value="" placeholder="Time" id="add-starttime" name="LTstart" class="form-control input-small input-white" required="required" style="width: 400px;" readonly>
								<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
							</div>

							<label>End Time:</label>
							<div class="input-group bootstrap-timepicker timepicker input-width-sm">
								<input type="text" value="" placeholder="Time" id="add-endtime" name="LTend" class="form-control input-small input-white" required="required" style="width: 400px;" readonly>
								<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
							</div>	
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Value:</label>
							<div class="input-group bootstrap-timepicker timepicker input-width-sm">
								<input type="text" value="" placeholder="Time" id="add-value" name="LTvalue" class="form-control input-small input-white" required="required" style="width: 400px;" readonly>
								<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
							</div>	
						</div>
...
<script type="text/javascript">
	$('#add-starttime').timepicker({showMeridian: false,showSeconds: true,defaultTime: '0:0'});
	$('#add-endtime').timepicker({showMeridian: false,showSeconds: true,defaultTime: '0:0'});
	$('#add-value').timepicker({showMeridian: false,showSeconds: true,defaultTime: '0:0'});
...
<script src="js/ajax.js"></script>
	 <script  type="text/javascript">
		...
		$('#datatbl tbody tr').click(function(){
			...
			locend = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(2)").text();
			locvalue = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(3)").text();
			locrecid = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(4)").text();
			so = usernum.toString();
		...
		CreateBtn.onclick = function() {
		    ...
		    document.getElementById("add-starttime").value = '0:00:00';
			document.getElementById("add-endtime").value = '0:00:00';
			document.getElementById("add-value").value = '0:00:00';
		...
		UpdateBtn.onclick = function() {
			if(so != '') {
				...
				document.getElementById("add-value").value = locvalue.toString();
		...
		function Clear()
		{
			if(so != '')
			{
				...
				//document.getElementById("add-starttime").value = "";
				document.getElementById("add-endtime").value = "";
