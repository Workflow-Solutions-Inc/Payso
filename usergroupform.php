...
<body>-->
	...
	<div id="leftpanel" class="leftpanel">
		...
		<ul class="subbuttons">
			...
			<li class="UserGroupsMaintain" style="display: none;"><button id="myAddBtn"><span class="fa fa-plus"></span> Create Record</button></li>
			<li class="UserGroupsMaintain" style="display: none;"><button onClick="Delete();"><span class="fa fa-trash-alt"></span> Delete Record</button></li>
			<li class="UserGroupsMaintain" style="display: none;"><button id="myUpdateBtn"><span class="fa fa-edit"></span> Update Record</button></li>
			<li><button onClick="Cancel();"><span class="fa fa-arrow-circle-left fa-lg"></span> Back</button></li>
		</ul>
		
		<!-- extra buttons -->
		<ul class="extrabuttons UserGroupsMaintain" style="display: none;">
			<div class="leftpanel-title"><b>SET</b></div>
			<li><button onClick="AddPriv();"><span class="fas fa-cog fa"></span> Set Priviledge</button></li>
			<li><button onClick="Adduser();"><span class="fas fa-cog fa"></span> Set User</button></li>
								...
								<tbody id="result">
									...
									{ 
										...
										$rowcnt2++;
											...
											$collection = $collection.','.$row['usergroupid'];
										?>
									...
									<?php 
										...
										$firstresult = $row2["usergroupid"];

									}?>
								</tbody>
								<span class="temporary-container-input">
									<input type="hidden" id="hide" value="<?php if(isset($_SESSION['groupid'])){ echo $grpid; } else { echo $firstresult; } ?>">
	...
	<div class="modal-container">
		<div class="modal-content">
			<div class="modal-header">
				<div class="col-lg-6">User Group</div>
				<div class="col-lg-6"><span class="fas fa-times modal-close"></span></div>
			</div>
			
			<div id="container" class="modal-content-container">
				<form name="myForm" accept-charset="utf-8" action="usergroupformprocess.php" method="get">
					<div class="row">
...
<script src="js/ajax.js"></script>
	 <script  type="text/javascript">
		...
		UpdateBtn.onclick = function() {
			...
			{
				alert("Please Select a the record you want to update.");
			}
		}
		...
		function checkExistForm()
		{
			...
			//alert(n);
			if(n == true){
				alert("User Group ID already Exist!");
				return false;
			}
			else
			{
