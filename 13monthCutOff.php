...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(140, 5, '13th Month Report (Monthly-Per Cut Off)', 0, false, 'C', 0, '', 0, false, 'M', 'M');
      ...
      //  $this->Cell(50, 15, $yr, 0, false, 'C', 0, '', 0, false, 'M', 'M');
       $this->Cell(50, 15, 'From December '.$yrInt.' to November '.$_GET["yr"] .'', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        $this->Cell(15, 5, 'January', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        $this->Cell(10, 5, 'October', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        $this->Cell(10, 5, 'November', 0, false, 'C', 0, '', 0, false, 'M', 'M');

        
 
        $this->Cell(8, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(8, 5, '13th MNTH', 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
$pdf->SetTitle('13th Month Report (Monthly-Per Cut Off)');
...
$query = "CALL `13thMonthReportPerCutoffweb`('$soc',$yr)";
        ...
        while ($row = $result->fetch_assoc())
        {
            ...
            $output .= ' <table width="100%"  cellpadding="1" border="1">
                         ...
                         <tr>
                            <td rowspan="2"  width="2%" style="text-align:right; valign="bottom;"">'.$row["num"].'</td>
                            <td rowspan="2"  width="10%"  style="vertical-align : middle;text-align:left;" >'.$row["name"].'</td>
                      
                            <td  width="6%"  style="text-align:right">'.$row["decco_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m1_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m2_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m3_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m4_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m5_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m6_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m7_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m8_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m9_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m10_1"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m11_1"].'</td>
                            <td rowspan="2"  width="6%"   style="vertical-align : middle;text-align:right;">'.$row["TMTH"].'</td>
                        </tr>
                        <tr>
                         
                            <td  width="6%"  style="text-align:right">'.$row["decco_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m1_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m2_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m3_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m4_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m5_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m6_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m7_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m8_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m9_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m10_2"].'</td>
                            <td  width="6%"  style="text-align:right">'.$row["m11_2"].'</td>
