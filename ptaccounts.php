								...
								<tbody id="result">
									...
									{ ?>
										<?php
											...
											$query2 = "SELECT * FROM payrolldetailsaccounts where dataareaid = '$dataareaid' and payrollid = '$paynum' and reflinenum = '$refnum' and accountcode = '$accExist'";
										...
										<tr id="<?php echo $row['accountcode'];?>" class="<?php echo $rowclass; ?>" tabindex="<?php echo $rowcnt2; ?>">
											...
											<td style="width:5%;"><input type='checkbox' id="chkbox" name="chkbox" class="checkbox" 
												value="<?php echo $row['accountcode'];?>" <?php echo ($tag==1 ? 'checked' : '');?> <?php echo ($tag==1 ? 'disabled' : '');?> ></td>
