        ...
        while ($row = $result->fetch_assoc())
        {
            ...
            $output .= ' <table width="100%"  cellpadding="1" border="1">
                         ...
                         <tr>
                            ...
                            <td rowspan="2"  width="15%"  style="vertical-align : middle;text-align:left;" >'.$row["name"].'</td>
                      
                            <td  width="8%"  style="text-align:right">'.$row["decco_1"].'</td>
                            ...
                            <td rowspan="2"  width="8%"   style="vertical-align : middle;text-align:right;">'.$row["TMTH"].'</td>
                        </tr>
                        <tr>
                         
                            <td  width="8%"  style="text-align:right">'.$row["decco_2"].'</td>
