    ...
    public function Header() {
      ...
      //  $this->Cell(50, 15, $yr, 0, false, 'C', 0, '', 0, false, 'M', 'M');
       $this->Cell(50, 15, 'From December '.$yrInt.' to November '.$_GET["yr"] .'', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        $this->Cell(8, 5, '4th QTR', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        $this->Cell(7, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(8, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Cell(8, 5, '13th Month', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        while ($row = $result->fetch_assoc())
        {
            ...
            $output .= ' <table cellspacing="0" cellpadding="1" border="1">
                        <tr>
                            ...
                            <td  width="12%"  style="text-align:right">'.$row["TOTAL"].'</td>
                            <td  width="13%"  style="text-align:right">'.$row["TMTH"].'</td>
