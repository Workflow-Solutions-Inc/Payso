        ...
        // Extend the TCPDF class to create custom Header and Footer
            class MYPDF extends TCPDF {
                ...
                public function Header() {
                    ...
                    $this->Cell(60, 5, 'ATM Report', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                    ...
                    $this->Cell(19, 15, 'Payroll Date: '.$_GET["paydate"], 0, false, 'C', 0, '', 0, false, 'M', 'M');

                    $this->SetFont('helvetica', 'B', 8);
                    $this->Cell(20, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                    $this->Cell(20, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                    $this->Cell(104, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                    ...
                    $this->Cell(18, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                    $this->Cell(20, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');
                    $this->Cell(20, 5, '', 0, false, 'C', 0, '', 0, false, 'M', 'M');

                    $this->Cell(20, 5, 'Bank Account No.', 0, false, 'C', 0, '', 0, false, 'M', 'M');
           ...
           /*  $qryTotal = "SELECT  format(sum(replace(accountvalue,',','')),2)  as 'Total' FROM atmtotal;";
                ...
                $totalresult = $conn->query($queryTotal);
                       ...
                       $outputTotal = '<tr>
                                    ...
                                    <th></th>
                                      <th></th>
                                      <tr>
                                         <td  width="59%" style="font-weight:bold;text-align:right;color:#FF0000;">Total:</td>
                                     </tr>
                                     <br>
                                     </br>
                                     <br>
            ...
            $finaloutput =  $startoutput.$output;    
                                ...
                                //header('Content-Disposition: attachment; filename=ATM_as_of_'.$currentDateTime.'.xls');
                               //echo $finaloutput;
                               //header("refresh:0;url=ticketmonitoring.php");
