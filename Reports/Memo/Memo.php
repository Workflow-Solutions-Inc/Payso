...
$query = "SELECT * from memoheader where memoid = '$memoid';";
  ...
  $query2 = "SELECT wk.name as receiver from memoheader mh
          ...
          where mh.memoid = '$memoid' and md.status = 'Receiver';";
   ...
   $query4 = "SELECT * from dataarea where dataareaid = '$dataareaid';";
