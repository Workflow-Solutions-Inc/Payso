...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(30, 15, 'Plastic Consumer Corp.', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        $this->Cell(60, 5, 'Deductions Report', 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
$pdf->SetTitle('Deductions Report');
...
$query = "CALL `paysys2019_dev`.`deductionsreport`('PCC', 'PCC0000665', 'PIBIG');";
        ...
        while ($row = $result->fetch_assoc())
        {
            ...
            $output .= '
                        ...
                        <tr>
                            ...
                            <td  width="28%"  style="text-align:left">'.$row["workername"].'</td>
                            <td  width="19%"  style="text-align:right">'.$row["contractid"].'</td>
                            <td  width="12%"  style="text-align:right">'.$row["accountvalue"].'</td>
                            <td  width="12%"  style="text-align:right">'.$row["balance"].'</td>
                        </tr>
    ...
    $totalresult = $conn->query($queryTotal);
           ...
           $outputTotal = '<tr>
                        ...
                        <th></th>
                          <th></th>
                          <tr>
                             <td  width="65%" style="font-weight:bold">Total</td>
                         </tr>
                         <br>
                         </br>
                         <br>
