...
$tinelineno11 =  '';
$wkid = $_GET['worker'];
$query = "select wk.name wkname, date(wk.datehired) datefrom ,date(wk.inactivedate) dateto,ps.name psname,wk.sssnum from worker wk left join position ps on wk.position = ps.positionid and wk.dataareaid = ps.dataareaid where wk.workerid = '".$wkid."' ";
