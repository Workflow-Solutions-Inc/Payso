	...
	$pdf=new PDF('P','mm','letter');
        ...
        while ($row = $result->fetch_assoc())
        {
					...
					$html='
						...
						<table border="0">
						<tr>
							<td width="120" height="30" bgcolor="#ffffff">Name:</td>
							<td width="200" height="30" bgcolor="#ffffff">'.$name.'</td>
							<td width="150" height="30" bgcolor="#ffffff">Position:</td>
							<td width="250" height="30" bgcolor="#ffffff">'.$position.'</td>
						</tr>
						<tr>
							<td width="120" height="30" bgcolor="#d5dadb">Rate:</td>
							<td width="200" height="30" bgcolor="#d5dadb">'.$rate.'</td>
							<td width="150" height="30" bgcolor="#d5dadb">Department:</td>
							<td width="250" height="30" bgcolor="#d5dadb">'.$department.'</td>
						</tr>

						<tr>
							<td width="120" height="30">Worker Id:</td>
							<td width="200" height="30">'.$workerid.'</td>
							<td width="150" height="30">Internal Id:</td>
							<td width="250" height="30">'.$internalid.'</td>
						</tr>
						...
						<tr>
							<table border="0">
								...
								<tr>
									...
									<td width="100" height="30" bgcolor="#d5dadb"  border="1"><font face="courier new" color="#212324">'.$lateH.'</font></td>
								</tr>
							...
							<table border="0">
								...
								<tr>
									<td width="620" height="30" bgcolor="#ffffff"><font face="courier new" color="#212324">Tax:</font></td>
									<td width="100" height="30" bgcolor="#ffffff"><font face="courier new" color="#212324">'.$tax.'</font></td>
								</tr>
								<tr>
									<td width="620" height="30" bgcolor="#d5dadb"><font face="courier new" color="#212324" >Company Charges:</font></td>
								...
								<tr>
									<td width="620" height="30" bgcolor="#d5dadb"><font face="courier new" color="#212324">Shuttle:</font></td>
									<td width="100" height="30" bgcolor="#d5dadb"><font face="courier new" color="#212324">'.$shuttle.'</font></td>
								</tr>
								<tr>
