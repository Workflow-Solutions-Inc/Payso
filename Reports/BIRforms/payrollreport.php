...
$query_ph = " select concat('Payroll Cover: ' ,date_format(fromdate,'%m/%d/%Y'), ' - ' ,date_format(todate,'%m/%d/%Y')) as 'ph_date',da.name as 'Company',br.name as 'Branch'  from payrollheader ph
							...
							where payrollid = '".$payrollid_."' and dataareaid = '".$dataarea."' ";
...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(25, 10, $comp, 0, false, 'C', 0, '', 0, false, 'M', 'M');
        ...
        $this->SetTextColor(0,0,0);
        // Title
        $this->Cell(9, 10, $ph_date , 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
$startoutput = '
						<table table width="100%"  cellpadding="1" border="0">
                      	...
                      	<tr>	
                            ...
                            <td  width="5%"  style="text-align:left" bgcolor="#d5dadb">W/Tax</td>
                            ...
                            <td  width="5%"  style="text-align:left" bgcolor="#d5dadb">Sunday</td>
                            <td  width="5%"  style="text-align:left" bgcolor="#d5dadb">Sunday Amount</td>
                        ...
                        <tr>
                            ...
                            <td  width="5%"  style="text-align:left">Canteen</td>
                            <td  width="5%"  style="text-align:left">Apartment</td>
...
//$query = "CALL payslipRPT('WFSIPY0000005', 'WFSI', 'WFSIWR000002')";
       ...
       // $row = $result->fetch_assoc();
						...
						while ($row = $result->fetch_assoc())
						{
                      	...
                      	<tr>
                            ...
                            <td  width="5%"  style="text-align:right" bgcolor="#d5dadb">'.number_format($row['WTAX'],2).'</td>
                        ...
                        <tr>
                            ...
                            <td  width="5%"  style="text-align:right">'.number_format($row['CTN'],2).'</td>
                            <td  width="5%"  style="text-align:right">'.number_format($row['APT'],2).'</td>
 ...
 $output.='<table width="100%"  cellpadding="1" border="1">
                      	...
                      	<tr>
                            ...
                            <td  width="5%"  style="text-align:right" bgcolor="#d5dadb"><b>'.number_format($tTax,2).'</b></td>
                        ...
                        <tr>
                            ...
                            <td  width="5%"  style="text-align:right"><b>'.number_format($tCN,2).'</b></td>
                            <td  width="5%"  style="text-align:right"><b>'.number_format($tAP,2).'</b></td>
