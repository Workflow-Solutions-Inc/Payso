...
//$query = "CALL payslipRPT('WFSIPY0000005', 'WFSI', 'WFSIWR000002')";
  ...
  /* <Virtual loop> */
  $pdf->AddPage();
  $pdf->setSourceFile('BIR Form 1601-EQ.pdf');
  ...
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(146.5, 57.5);
  $pdf->Write(0, $tinelineno10);

    #column 12
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(151.5, 57.5);
  ...
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(191.5, 57.5);
  $pdf->Write(0, $rdo1);
  #RDO Code 2
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(196.5, 57.5);
  $pdf->Write(0, $rdo2);
  #RDO Code 3
  $pdf->SetFont('Arial','B',10);
  $pdf->SetTextColor(0, 0, 0);
  $pdf->SetXY(201.5, 57.5);
  $pdf->Write(0, $rdo3);
/*
  #Registered Address
  $pdf->SetFont('Arial','B',10);
