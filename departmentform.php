...
<body>-->
	...
	<div id="leftpanel" class="leftpanel">
		...
		<ul class="subbuttons">
			...
			<li class="DepartmentMaintain" style="display: none;"><button id="myAddBtn"><span class="fa fa-plus"></span> Create Record</button></li>
			<li class="DepartmentMaintain" style="display: none;"><button onClick="Delete();"><span class="fa fa-trash-alt"></span> Delete Record</button></li>
			<li class="DepartmentMaintain" style="display: none;"><button id="myUpdateBtn"><span class="fa fa-edit"></span> Update Record</button></li>
				...
				<div id="tablearea1" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mainpanel-area">
					<div class="mainpanel-content">
						...
						<div class="mainpanel-title">
							<span class="fa fa-archive"></span> Department
						</div>
								...
								<thead>
									...
									<tr class="rowsearch">
									  <td class="text-center"><span class="fas fa-search fa-xs"></span></td>
										...
										<td style="width:25%;"><input list="SearchDepartment" class="search">
										<?php
									  ...
									  <td style="width:width:25%;"><input list="SearchName" class="search">
										<?php
								...
								<tbody id="result">
									...
									{ 
										...
										$rowcnt2++;
											...
											$collection = $collection.','.$row['departmentid'];
										?>
										<tr id="<?php echo $row['departmentid'];?>" class="<?php echo $rowclass; ?>" tabindex="<?php echo $rowcnt2; ?>">
	...
	<div class="modal-container">
		<div class="modal-content">
			...
			<div id="container" class="modal-content-container">
				<form name="myForm" accept-charset="utf-8" action="departmentformprocess.php" method="get">
					<div class="row">

						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Department ID:</label>
							<input type="text" value="" placeholder="Department ID" name ="DeptId" id="add-department" class="modal-textarea" required="required">
	 ...
	 <script  type="text/javascript">
		...
		CreateBtn.onclick = function() {
		   //modal.style.display = "block";
		    ...
		    $("#add-department").prop('readonly', false);
		...
		UpdateBtn.onclick = function() {
			if(so != '') {
				...
				document.getElementById("add-name").value = locDeptId;
		...
		function checkExistForm()
		{
			...
			//alert(myId.length);
			var n = myId.includes(document.getElementById("add-department").value.toLowerCase());
			//alert(n);
			if(n == true){
