...
<body>-->
	...
	<div id="leftpanel" class="leftpanel">
		...
		<ul class="subbuttons">
			...
			<li><button onClick="AddUsr();"><span class="fa fa-plus"></span> Add User</button></li>
			<li><button onClick="Delete();"><span class="fa fa-trash-alt"></span> Remove User</button></li>
				...
				<div id="tablearea1" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mainpanel-area">
					<div class="mainpanel-content">
						...
						<div class="mainpanel-title">
							...
							?>
							<span class="fa fa-archive"></span> List of User for <?php echo $grpname;?> 
						</div>
								...
								<thead>
									...
									<tr class="rowsearch">
									  <td class="text-center"><span class="fas fa-search fa-xs"></span></td>
									   ...
									   <td><input list="SearchUser" class="search">
										<?php
											$query = "SELECT distinct uf.userid
								...
								<tbody id="result">
									...
									{ 
										...
										<tr class="<?php echo $rowclass; ?>">
											...
											<td style="width:50%;"><?php echo $row['userid'];?></td>
...
<script src="js/ajax.js"></script>
	...
	$( ".search" ).on( "keydown", function(event) {
	  if(event.which == 13){
		...
		var data=[];
		 ...
		 $.ajax({
					type: 'GET',
					url: 'usergroupsassignmentprocess.php',
					data:{action:action, actmode:actionmode, UsrId:UsrId, name:name},
		...
		if(so != '') {
			if(confirm("Are you sure you want to remove this record?")) {
				$.ajax({	
						...
						data:{action:action, actmode:actionmode, UsrId:so},
						beforeSend:function(){
	...
	function AddUsr()
	{
		...
		$.ajax({
			...
			success: function(data) {
			    window.location.href='userselection.php';
		    }
		});
	}
</script>
