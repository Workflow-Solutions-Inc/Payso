...
function Recompute($refnum,$payID,$dtID,$conPAR) 
{
	$id = $refnum;
	$paynum = $payID;
	$dataareaid = $dtID;
	...
	$sqlinsertcon = "call PT_PayrollComputation('$paynum','$dataareaid','$id','ins_con','','')";
			...
			while ($row3 = $result3->fetch_assoc())
				{
					...
					else
					{
						...
						/*$query5a = "SELECT * from accountconditioncomputation a
							...
							$result5a = $conn->query($query5a);
							while ($row5a = $result5a->fetch_assoc())
							{
								$resformula = $row5a["resultformula"];
								$ConCode = $row5a["accountconditioncode"];
								$acccode5a = $row5a["accountcode"];
								...
								$res2 = preg_replace("/[^0-9\+\-*\/\.,() ]/", "0", $resformula); 
										
								$res2 =  preg_replace("/[^0-9\+\-*\/\.() ]/", "", $res2);

								eval('$comresult2 = '.$res2.';');

								$sql5a = "UPDATE accountconditioncomputation SET resultformula = $comresult2
												WHERE payrollid = '$paynum'
												and reflinenum = '$id'
												and dataareaid = '$dataareaid'
												and accountcode = '$acccode5a'
												and accountconditioncode = 'TAX-2'";
									if(mysqli_query($conn,$sql5a))
										{
											//echo "sql3=".$sql3."<br>";
											//echo "Rec Updated";
											echo $sql5a."<br>".$conn->error;
										}
										else
										{
											echo "error".$sql5a."<br>".$conn->error;
										}
							...
							//and a.conditionformula <= cast(a.referenceformula as decimal(38,2))
							//and a.accountcode = '$acccode2' and a.accountcode = 'tax'
						...
						else //if($acccode2 == 'SSS' || $acccode2 == 'PH')
						{
							...
							//echo "<br>";
							$query11 = "call PT_Contribution('ADMO','$resformula','$acccode2')";
						...
						/*else if($acccode2 == 'PH')
						{
							//call PT_PHcontribution('ADMO',60000);
							$resultformula = 200;
							$query11 = "call PT_Contribution('ADMO',20000,'$acccode2')";
						...
						/*$eq = preg_replace("/[^0-9\+\-*\/\.,() ]/", "0", $resultformula); 
						...
						/*$sql6 = "UPDATE payrolldetailsaccounts SET value = $resultformula
								WHERE payrollid = '$paynum'
								and reflinenum = '$id'
								and dataareaid = '$dataareaid'
								and accountcode = '$acccode2'";
						...
						$sql6A = "UPDATE payrolldetailcomputation SET formula = $resultformula
								WHERE payrollid = '$paynum'
								and reflinenum = '$id'
								and dataareaid = '$dataareaid'
								and accountcode = '$acccode2'";
							if(mysqli_query($conn,$sql6A))
								{
									//echo "sql3=".$sql3."<br>";
									//echo "Rec Updated";
									//echo "error".$sql6A."<br>".$conn->error;
								}
								else
								{
									echo "error".$sql6A."<br>".$conn->error;
			...
			$query6 = "SELECT * from accountconditioncomputation a
							...
							and a.dataareaid = '$dataareaid'
							and a.conditionformula <= cast(a.referenceformula as decimal(38,2))
							order by priority DESC ,linenum DESC
							limit 1
							";
			$result6 = $conn->query($query6);
			$row6 = $result6->fetch_assoc();
			...
			$resultcode = $row6["accountcode"];
				...
				$sql6 = "UPDATE payrolldetailsaccounts SET value = format('$resultformula',2)
								WHERE payrollid = '$paynum'
								and reflinenum = '$id'
								and dataareaid = '$dataareaid'
								and accountcode = '$resultcode'";
							if(mysqli_query($conn,$sql6))
								{
									//echo "sql3=".$sql3."<br>";
									//echo "Rec Updated";
				...
				$sql6A = "UPDATE payrolldetailcomputation SET formula = format('$resultformula',2)
								WHERE payrollid = '$paynum'
								and reflinenum = '$id'
								and dataareaid = '$dataareaid'
								and accountcode = '$resultcode'";
			...
			$query7 = "SELECT accountcode,
							...
							and reflinenum = '$id'
							and dataareaid = '$dataareaid'
							and accounttype in (1,2)
							order by priority";
			$result7 = $conn->query($query7);
			while ($row7 = $result7->fetch_assoc())
				{
					//select here then update
					$concode = $row7["accountcode"];
					$convalue = $row7["value"];

					if($convalue != 0)
					{
						$sql7 = "call PT_PayrollComputation('$paynum','$dataareaid','$id','Compute_0','$concode','$convalue')";
...
function sss_deduction($dtID,$conPAR) 
{


}

function Ben_deduct($refnum,$payID,$dtID,$conPAR) 
{
	$id = $refnum;
	$paynum = $payID;
	$dataareaid = $dtID;
