							...
							<thead>
								...
								<tr class="rowA">
								  <td><span class="fa fa-adjust"></span></td>
									...
									<td style="width:25%;"><input style="width:100%;height: 20px;" list="SearchLoan" class="search">
									<?php
			...
			<div id="container" class="modal-content-container">
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<input type="text" value="" placeholder="Loan Type ID" id="add-loan" class="modal-textarea">

						<label>Description:</label>
						<input type="text" value="" placeholder="Description" id="add-name" class="modal-textarea">
					</div>
