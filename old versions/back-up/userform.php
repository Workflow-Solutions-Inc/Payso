							...
							<thead>
								...
								<tr class="rowA">
								  <td><span class="fa fa-adjust"></span></td>
									...
									<td style="width:25%;"><input style="width:100%;height: 20px;" list="SearchUserid" class="search">
									<?php
								  ...
								  <td style="width:25%;"><input style="width:100%;height: 20px;" list="SearchName" class="search">
									<?php
								  ...
								  <td style="width:25%;"><input style="width:100%;height: 20px;" list="SearchDataarea" class="search">
									<?php
								  ...
								  <td style="width:25%;"><input style="width:100%;height: 20px;" list="SearchPass" class="search" disabled>
									<?php
							...
							<tbody id="result">
								...
								{ ?>
									<tr class="rowA">
										...
										<td><?php echo $row['defaultdataareaid'];?></td>
