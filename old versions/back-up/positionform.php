						...
						<table width="100%" border="0" id="datatbl">
							<thead>
								<tr class="rowB rowactive">
									...
									<td style="width:50%;">Position ID</td>
								...
								<tr class="rowA">
								  <td><span class="fa fa-adjust"></span></td>
									...
									<td style="width:25%;"><input style="width:100%;height: 20px;" list="SearchPosition" class="search">
									<?php
							...
							<tbody id="result">
								...
								{ ?>
									<tr class="rowA">
										...
										<td><span class="fa fa-adjust"></span></td>
										<td style="width:50%;"><?php echo $row['positionid'];?></td>
			...
			<div id="container" class="modal-content-container">
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<input type="text" value="" placeholder="Position ID" id="add-position" class="modal-textarea">
