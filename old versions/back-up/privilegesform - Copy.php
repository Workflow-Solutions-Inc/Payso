				...
				<form accept-charset="utf-8" action="loginprocess.php" method="post">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="text" value="" placeholder="Privilege Id" id="add-privilege" class="modal-textarea">

							<label>Module:</label>
							<input type="text" value="" placeholder="Module" id="add-module" class="modal-textarea">
						</div>

						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Sub Module:</label>
							<input type="text" value="" placeholder="Sub Module" id="add-submodule" class="modal-textarea">
