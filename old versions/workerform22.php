			...
			<div class="row">
								...
								<thead>
									...
									<tr class="rowsearch">
									  <td class="text-center"><span class="fas fa-search fa-xs"></span></td>
										...
										<td><input list="SearchDepartment" class="search">
										<?php
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mainpanel-area">
					<div class="mainpanel-content">
						<div class="mainpanel-title">
							<div class="row">
								<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12"><span class="fa fa-archive"></span> Personal Info</div>
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12"><span class="fa fa-archive"></span> General Info</div>
							</div>
						</div>
						<!-- tableheader -->
						<div class="half">
