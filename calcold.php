				...
				<div id="tablearea1" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mainpanel-area">
					<div class="mainpanel-content">
						...
						<div class="mainpanel-title">
							<span class="fa fa-archive"></span> Account Formula
						</div>
						...
						<div id="calculator-container" class="calculator-container">
							<div class="calculator card">
								...
								<textarea class="calculator-screen z-depth-1" value="2.0"  id="calc-result" readonly>0.00</textarea>
								...
								<div class="calculator-keys">
									...
									<button type="button" class="operator btn btn-info" id="[ecola]" name="Ecola" value="[ecola]" onclick='accval(this.value);'>E</button>
								...
								<div class="calculator-keys">
									...
									<button id="calc-ac" type="button" class="all-clear function btn btn-danger btn-sm" value="all-clear">AC</button>
						...
						<div id="container1" class="full widthsplit">
							...
							<div class="button-ok">
								...
								<button class="btn btn-primary btn-lg calc-confirmation" onclick="SampleAlert2();">Accept</button>
							</div>
						</div>
						<!--right pannel-->
						<!--right pannel 2-->
								...
								<div class="dashboard-content">
									...
									<div>
										...
										<div class="button-ok">
											...
											<button class="btn btn-primary btn-lg" onclick="SampleAlert();">Test</button>
