...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        if($_GET["wkType"] == "0"){$cell_1 = 40;$cell_2 = 101;}
        if($_GET["wkType"] == "1"){$cell_1 = 50; $cell_2 = 81;}
        ...
        $this->Cell($cell_1, 5, 'Pag-Ibig Contribution Report', 0, false, 'C', 0, '', 0, false, 'M', 'M');


        $this->SetFont('helvetica', 'B', 8);
        $this->Cell($cell_2 , 15, 'Printed By: Admin', 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
$pdf->SetTitle('Pag Ibig Contribution Report');
    ...
    $totalresult = $conn->query($queryTotal);
           ...
           $outputTotal = '<tr>
                        ...
                        <th></th>
                         ...
                         <br>
                          <tr>
                             <td  width="10%" style="font-weight:bold">Grand Total</td>
                         </tr>
                         </br>
                         <br>
                         </br>
